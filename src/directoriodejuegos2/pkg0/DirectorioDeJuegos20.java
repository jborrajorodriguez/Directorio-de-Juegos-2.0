...
public class DirectorioDeJuegos20 {
    ...
    public static void main(String[] args) {
        ...
        FuncionesBase.insertPlataforma(2, "Play Station", "4", "Sony", "La nueva PS4 más delgada y ligera, la consola más vendida del mundo, incluye gran potencia para tus juegos en versiones de 500 GB y 1 TB. Ya disponible en Jet Black, Glacier White y los fantásticos Gold y Silver.");
